      ...
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        ...
        <div className="w-full md:w-96 relative group">
          <input 
            ...
            className="w-full bg-white dark:bg-zinc-900 border border-[#E5E5E0] dark:border-zinc-800 rounded-full pl-12 pr-4 py-3 focus:outline-none focus:border-[#5A5A40] dark:focus:border-zinc-600 transition-all font-bold text-[#1A1A1A] dark:text-white shadow-sm"
          />
          <Search className="w-5 h-5 absolute left-4 top-1/2 -translate-y-1/2 text-[#8E8E8E] dark:text-gray-500 group-focus-within:text-[#5A5A40] dark:group-focus-within:text-zinc-400 transition-colors" />
        </div>
      </header>
        ...
        <section className="bg-[#5A5A40] dark:bg-zinc-800 rounded-3xl p-8 text-white shadow-xl shadow-[#5A5A40]/20 dark:shadow-none relative overflow-hidden">
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-1 gap-3">
              ...
              <button 
                disabled
                className="bg-white/10 text-white/50 cursor-not-allowed font-bold py-4 px-6 rounded-2xl flex items-center justify-between border border-white/10 relative overflow-hidden group"
              >
                ...
                <RefreshCwIcon className="w-5 h-5 opacity-50" />
              </button>
            </div>
          </div>
